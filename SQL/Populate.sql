...
INSERT INTO Enrollment (GPA_Value, GPA_Percentage, EnrollDate, CourseID, StudentID) VALUES
    (3.5, 87.50, '2021-09-01', 1, 1),
    (3.8, 95.00, '2022-01-15', 2, 2),
    (3.6, 90.00, '2020-08-20', 3, 3),
    (3.7, 92.50, '2019-05-10', 1, 4),
    (3.9, 97.50, '2023-03-12', 2, 5),
    (3.4, 85.00, '2021-11-25', 3, 6),
    (3.2, 80.00, '2020-07-18', 1, 7),
    (3.6, 90.00, '2019-10-09', 2, 8),
    (3.8, 95.00, '2023-02-01', 3, 9),
    (3.7, 92.50, '2022-09-13', 1, 10),
    (3.5, 87.50, '2021-12-05', 2, 11),
    (3.6, 90.00, '2020-06-30', 3, 12),
    (3.7, 92.50, '2021-04-15', 1, 13),
    (3.8, 95.00, '2022-01-10', 2, 14),
    (3.5, 87.50, '2020-03-19', 3, 15),
    (3.6, 90.00, '2019-05-25', 1, 16),
    (3.7, 92.50, '2023-07-15', 2, 17),
    (3.8, 95.00, '2022-10-30', 3, 18),
    (3.5, 87.50, '2021-09-08', 1, 19),
    (3.6, 90.00, '2020-08-18', 2, 20),
    (3.4, 85.00, '2023-01-10', 1, 21),
    (3.5, 87.50, '2020-12-05', 2, 22),
    (3.6, 90.00, '2019-11-18', 3, 23),
    (3.8, 95.00, '2021-06-25', 1, 24),
    (3.9, 97.50, '2022-07-13', 2, 25),
    (3.7, 92.50, '2023-02-18', 3, 26),
    (3.6, 90.00, '2020-03-29', 1, 27);
